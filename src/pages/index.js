...
const Home = (props) => {
  return (
    <>
      ...
      <BuyBar {...props} />
      <Box sx={{ py: '56px' }}>
        <TopContainer {...props.data} />
        <BottomContainer {...props.data} />
      </Box>
    </>
  );
};
...
export async function getStaticProps() {
  const data = {
    ...
    curriculum: [
      { title: 'Introduction', topics: [{ text: 'Introduction' }] },
      {
        title: 'Environment',
        topics: [
          { text: 'Blockchain' },
      ...
      {
        title: 'Blockchain Game - Game intelligence',
        topics: [
          { text: 'Overview' },
      ...
      {
        title: 'Blockchain Game - Communicating with the Blockchain',
        topics: [
    ...
    instructor: {
      ...
      description:
        'With more than 15 years of experience in the software development area, graduated in Power Systems at IFSC and MBA in Software Architecture. Currently works with architecture and software development, focused on python backend development and C# .Net Core. Passionate about Machine Learning, an area in which he developed a music recognition service and also had the pleasure of winning some awards.'
    },
    sell: {
      price: 79.9,
      discount: 0.38,
    ...
    testimonial: [
      {
        ...
        stars: 4.5,
        comment:
          'This training is the most useful I found online...Easy to understand, and love how Neal explain everythings..Also his Exam cram helped a lot...'
      },
      {
        name: 'Joemerson Santos L.',
        stars: 5,
        comment:
          'The course has been good. Applauds to Neal for designing and delivering content to ensure effective learning. One improvement could have been in describing what the features of the incorrect answers represent, to increase learning and clarifying doubts in one go.'
      }
    ]
  };
