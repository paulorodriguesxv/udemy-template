      ...
      <Grid item xs={12} md={6} color="primary">        
        <Typography display="block" variant="h1" sx={{m: 1,}}>
         ...
         <Box sx={{ display: 'flex', flexDirection: {xs:'column', md:'row'}, m: 1,}}>
           <Chip label="Bestseller"  sx={{p: 1, m: 0}} color="primary"></Chip>
           <Box sx={{ display: 'flex', flexDirection: 'row'}}>
            ...
            <Typography  sx={{p:0, m: 1,}}>{classifications} Rattings - {students} students</Typography>
           </Box>
           
         </Box>     
         <Box sx={{ display: 'flex', flexDirection: 'row', m: 1,}}>           
           <Typography sx={{p:0, m: 0,}} variant="body2">Created by {createdBy}</Typography>
         </Box>              
         <Box sx={{ display: 'flex', flexDirection: 'row', m: 1,}}>           
           <Typography  sx={{p:0, m: 0,}} variant="body2">Last Updated {updatedAt} English, Portuguese</Typography>
          </Box>                       
      </Grid>
