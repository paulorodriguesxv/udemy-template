  ...
  return (
    <Box sx={{ m: 1, pt: 1 }}>
      ...
      <Typography
        display="block"
        variant="body2"
        sx={{ color: '#6a6f73', textDecoration: 'none' }}
      >
        {data.jobTitle}
      </Typography>
          ...
          <List dense>
            <ListItem>
              ...
              <Typography display="block" variant="body2" sx={{ pl: 1 }}>
                {data.score} Instructor Rating
              </Typography>
            </ListItem>
            <ListItem>
              <VerifiedIcon />
              <Typography display="block" variant="body2" sx={{ pl: 1 }}>
                {data.ratingNumber} Reviews
              </Typography>
            </ListItem>
            <ListItem>
              <PeopleIcon />
              <Typography display="block" variant="body2" sx={{ pl: 1 }}>
                {data.studentsTotal} Students
              </Typography>
            </ListItem>
            <ListItem>
      ...
      <Typography display="block" variant="body2" sx={{ pt: 2 }}>
        {data.description}
      </Typography>
    </Box>
  );
